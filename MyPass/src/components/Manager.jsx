...
const Manager = () => {
    ...
    const saveData = (e) => {
        ...
        if (i1.length != 0 && i2.length != 0 && i3.length != 0) {
            ...
            setAllPass([...allPass, { ...form, id: uuidv4() }])
    ...
    const handleEdit = (id) => {
        ...
        setform((allPass.filter(i => i.id === id))[0]);
        ...
        <>
            ...
            <div className="container mx-auto bg-slate-100 h-20   ">
                ...
                <div className="passwords mt-20">
                    ...
                    {allPass.length === 0 && <div className=' text-red-400 text-xl'>No passwords</div>}
                    {allPass.length != 0 &&
                            ...
                            <tbody>
                                ...
                                {allPass.map((val, i) => {
                                    ...
                                    return (<tr key={i} className='' >
                                        ...
                                        <td className=' text-center'><span>{val.password}</span></td>
